...
void About()
{
	...
	Textcolor(Pink);
	Sleep(1000);
	_Common::gotoXY(48, 22);
	cout << "Can Tho University - CTU" << endl;
	Sleep(1000);
	Textcolor(Red);
	_Common::gotoXY(48, 24);
	cout << "Product:" << endl;
	Textcolor(Green);
	_Common::gotoXY(57, 24);
	cout << "SNACK - Game Console" << endl;
	Textcolor(Red);
	Sleep(1000);
	...
	Sleep(1000);
	Textcolor(Red);
	_Common::gotoXY(48, 26);
	cout << "Instructor:" << endl;
	Textcolor(Green);
	_Common::gotoXY(60, 26);
	cout << "Huynh Cong Thanh" << endl;
	
	Sleep(1000);
	Textcolor(Yellow);
	_Common::gotoXY(47, 29);
	cout << "-> Chuc moi nguoi choi game vui ve !!" << endl;
	Textcolor(Green);
	_Common::gotoXY(60, 31);
	cout << "BACK";
	char command = ' ';
	command = _getch();
	system("cls");
...
void showHighScore() 
{
	...
	string s[100];*/
	Textcolor(Green);
	_Common::gotoXY(62, 18);
	cout <<"SCOREBOARD";
	Sleep(500);
	Textcolor(Red);
	_Common::gotoXY(29, 21);
	cout << "Rank" << endl;
	_Common::gotoXY(43, 21);
	cout << "Player" << endl;
	_Common::gotoXY(63, 21);
	cout << "Score" << endl;
	_Common::gotoXY(85, 21);
	cout << "Level" << endl;
	_Common::gotoXY(107, 21);
	cout << "Time" << endl;
	Sleep(500);
	Textcolor(Cyan);
	...
	_Common::gotoXY(43, 23);
	cout << "abcxyz";
	_Common::gotoXY(64, 23);
	cout << "300" << endl;
	_Common::gotoXY(87, 23);
	cout << "7" << endl;
	_Common::gotoXY(107, 23);
	cout << "05:15" << endl;
	Sleep(500);
	Textcolor(Cyan);
	_Common::gotoXY(30, 25);
	cout << "2";
	_Common::gotoXY(43, 25);
	cout << "player1";
	_Common::gotoXY(64, 25);
	cout << "240" << endl;
	_Common::gotoXY(87, 25);
	cout << "6" << endl;
	_Common::gotoXY(107, 25);
	cout << "04:23" << endl;
	Sleep(500);
	Textcolor(Cyan);
	...
	_Common::gotoXY(43, 27);
	cout << "test_1";
	_Common::gotoXY(64, 27);
	cout << "200" << endl;
	_Common::gotoXY(87, 27);
	cout << "6" << endl;
	_Common::gotoXY(107, 27);
	cout << "03:53" << endl;
	Sleep(500);
	Textcolor(Cyan);
	_Common::gotoXY(30, 29);
	cout << "4";
	_Common::gotoXY(43, 29);
	cout << "Thanh Dat";
	_Common::gotoXY(64, 29);
	cout << "160" << endl;
	_Common::gotoXY(87, 29);
	cout << "5" << endl;
	_Common::gotoXY(107, 29);
	cout << "02:19" << endl;
	Sleep(500);
	Textcolor(Cyan);
	_Common::gotoXY(30, 31);
	cout << "5";
	_Common::gotoXY(43, 31);
	cout << "test_2";
	_Common::gotoXY(64, 31);
	cout << "130" << endl;
	_Common::gotoXY(87, 31);
	cout << "4" << endl;
	_Common::gotoXY(107, 31);
	cout << "01:45" << endl;
	char command = ' ';
	command = _getch();
	system("cls");
	...
	int xgiay = SIZE * 4 + 38, ygiay = 6;
		while (true)
		{
			...
			if (gameOver() != true)
			{
				...
				else if (giay >= 10 && giay <= 59)
				{
					Textcolor(Cyan);
					_Common::gotoXY(xgiay + 3, ygiay);
					cout << giay;
					giay++;
